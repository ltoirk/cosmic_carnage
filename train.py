...
def train():
    ...
    print("============================================================================================")
    print("config : ", config)
    run = wandb.init(project="space-shooter", entity='spider-r-d', mode="offline", config=OmegaConf.to_container(config), notes=config.notes)
    ...
    checkpoint_path = directory + "{}_PPO_{}_{}_{}.pth".format(run.id,env_name, random_seed, run_num_pretrained)
